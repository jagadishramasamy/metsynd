...
#'
#'
#' @param x is the data set containing the following parameters such as Gender (Male or Female), Waist Circumference in cm, Triglycerides in mg/dL,Fasting_plasma_glucose in mg/dL,
#' HDL-cholesterol in mg/dL, Systolic BP in mm of Hg, Diastolic BP in mm of Hg
#'
#'
#' @return
#' @export
